...
export class LivingAppsService {
  ...
  static async createPersonenEntry(fields: Personen['fields']) {
    return callApi('POST', `/apps/${APP_IDS.PERSONEN}/records`, { fields });
  }
  static async updatePersonenEntry(id: string, fields: Partial<Personen['fields']>) {
    return callApi('PATCH', `/apps/${APP_IDS.PERSONEN}/records/${id}`, { fields });
  }
