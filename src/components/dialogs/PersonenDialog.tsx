...
import type { Personen } from '@/types/app';
...
export function PersonenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: PersonenDialogProps) {
