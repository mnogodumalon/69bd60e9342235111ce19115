...
export function ArtikelDialog({ open, onClose, onSubmit, defaultValues, einkaufslistenList, personenList, enablePhotoScan = true, enablePhotoLocation = true }: ArtikelDialogProps) {
