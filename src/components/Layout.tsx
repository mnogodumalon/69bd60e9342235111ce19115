...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconPackage, IconSettings, IconUsers } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

const APP_TITLE = 'Einkaufslisten-Manager';
...
const navigation = [
  ...
  { name: 'Artikel', href: '/artikel', icon: IconPackage },
  { name: 'Personen', href: '/personen', icon: IconUsers },
];

const externalNavigation = [
  { name: 'Einkaufslisten', href: '/gateway/apps/69bd60d5919ca5f05dca2818?template=list_page', icon: IconFileText },
  { name: 'Artikel', href: '/gateway/apps/69bd60d5279653ca0a8a1856?template=list_page', icon: IconPackage },
  { name: 'Personen', href: '/gateway/apps/69bd60d0fbc782bfece9bd53?template=list_page', icon: IconUsers },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69bd60d5919ca5f05dca2818?template=list_page"
