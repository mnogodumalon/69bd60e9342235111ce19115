...
const ARTIKEL_FIELDS = [
  ...
  { key: 'einheit', label: 'Einheit', type: 'lookup/select', options: [{ key: 'stueck', label: 'Stück' }, { key: 'kaesten', label: 'Kästen' }, { key: 'liter', label: 'Liter' }, { key: 'kilogramm', label: 'Kilogramm' }, { key: 'gramm', label: 'Gramm' }, { key: 'packung', label: 'Packung' }, { key: 'flasche', label: 'Flasche' }, { key: 'dose', label: 'Dose' }] },
  { key: 'status', label: 'Status', type: 'lookup/radio', options: [{ key: 'offen', label: 'Noch zu kaufen' }, { key: 'gekauft', label: 'Gekauft' }] },
  { key: 'einkaufsliste', label: 'Einkaufsliste', type: 'applookup/select', targetEntity: 'einkaufslisten', targetAppId: 'EINKAUFSLISTEN', displayField: 'listenname' },
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('einkaufslisten');
